...
const firebaseIdToolkitLoginUrl = import.meta.env.VITE_FIREBASE_ID_TOOLKIT_LOGIN_URL
...
export const firebaseLoginpUrl = `${firebaseIdToolkitLoginUrl}?key=${firebaseApikey}`
